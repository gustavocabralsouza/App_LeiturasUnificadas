	...
	<script language="Javascript">
		...
		function valida(){
			...
			if(document.f1.nome.value==""){
				alert("A Cor ...... tem que ser preenchida");
				vazio=true
			}
...
<ul id = "NavMenu">
	...
	$sql = "SELECT * FROM caixa where num_cai = $pesquisa";
	...
	<div id = "G1">
			...
			<form name="f1" method = "POST" action="altcaix2.php">
				<fieldset>		
					<p class = "TituloForm2">
						Alterar Caixa
					</p>
					<p class = "TextoForm">
						...
						<input type = "hidden" name = "Matricula" id = "Matricula" value=<?php echo $row['num_cai'] ?>>
					</p>
					<p class = "TextoForm">
						<label> Cor: </label><br>
						<input type = "text" name = "nome" id = "nome" value='<?php echo $row['cor'] ?>'/>
					</p>
					<br><br>
