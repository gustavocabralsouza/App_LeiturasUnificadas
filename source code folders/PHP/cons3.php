...
<?php
	...
	$sql = "SELECT amigos.cod_amigo,amigos.nome,emprestimo.cod_revista,revista.edicao FROM amigos inner join emprestimo on amigos.cod_amigo=emprestimo.cod_amigo inner join revista on revista.cod_revista=emprestimo.cod_revista where revista.edicao like 'Primeira';";
