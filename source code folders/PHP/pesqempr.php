...
<?php
	...
	$sql = "SELECT * FROM emprestimo where cod_revista = $pesquisa order by cod_revista";
...
<table align="center">
	...
	<tr>
		<td bgcolor=#FFFFff>
			<p align="center"> <b class="tbl_title">Empréstimos</b></p>
		</td>
	</tr>
</table>
